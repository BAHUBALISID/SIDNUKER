SERVER_CONFIG = {
    "new_name": "nuked by ghost",  # New Server Name here      
    "new_icon": "ghost here babe nextra here mfs you get fucked",   # New Server Icon url here → https://yourimage.jpg    
    "new_description": "nuked by ghost cry hard",  # New Server Description here    
}

WEBHOOK_CONFIG = {
    "default_name": "YOUR GHOST",  # Webhook Name here     
}
